...
import in.ults.ipms.di.component.DaggerFragmentComponent;
import in.ults.ipms.di.component.FragmentComponent;
...
public abstract class BaseFragment<T extends ViewBinding> extends Fragment implements IBaseView, View.OnKeyListener, AdaptiveStateLayout.AdaptiveStateLayoutListener {


    protected BaseActivity mActivity;
    private AdaptiveStateLayout mRootView;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (mRootView == null) {
            mRootView = new AdaptiveStateLayout(mActivity);
            viewBinding = initViewBinding(inflater, container, false);
            mRootView.setActualLayoutView(viewBinding.getRoot());
            mRootView.addFullStates(AdaptiveStateConstants.getFullStates());
