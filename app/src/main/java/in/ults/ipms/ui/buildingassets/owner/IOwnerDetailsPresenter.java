...
public interface IOwnerDetailsPresenter <V extends IOwnerDetailsView,I extends IOwnerDetailsInteractor> extends IBasePresenter<V,I> {
    ...
    void validateData(String firstName, String lastName, String email, String mobile,String landphone, String gender,String placeName,String village, String street,String ownerHouse, String ownerOccupation,String ownerPostoffice,String ownerSurveyNumber);
}
