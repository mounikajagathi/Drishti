...
public class OwnerDetailsFragment extends BaseFragment<FragmentOwnerDetailsBinding> implements IOwnerDetailsView {
    ...
    public static final int ERROR_TYPE_OWNER_HOUSE = 10;
    public static final int ERROR_TYPE_OWNER_OCCUPATION = 11;
    public static final int ERROR_TYPE_OWNER_POSTOFFICE = 12;
    public static final int ERROR_TYPE_OWNER_SURVEY_NUMBER = 13;
    ...
    void submitOnClick() {
        ...
        presenter.validateData(firstName, lastName, email, mobile, landphone, gender, placeName, village, street, ownerHouse, ownerOccupation, ownerPostoffice, ownerSurveyNumber);
