...
import in.ults.ipms.databinding.FragmentRoadJunctionDetailsBinding;
...
public class RoadJunctionDetailsFragment extends BaseFragment<FragmentRoadJunctionDetailsBinding> implements IRoadJunctionDetailsView, BaseActivity.ImagePickListener {
    ...
    @Inject
    IRoadJunctionDetailsPresenter<IRoadJunctionDetailsView, IRoadJunctionDetailsInteractor> presenter;
    ...
    @Override
    protected FragmentRoadJunctionDetailsBinding initViewBinding(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, boolean attachToParent) {
        return FragmentRoadJunctionDetailsBinding.inflate(inflater, container, attachToParent);
    }

    @Override
    protected String getToolbarTitle() {
        return getString(R.string.road_junction_details_title);
    }
    ...
    protected void init(View view) {
        ...
        getViewBinding().imgRoadJunction.setOnClickListener(v -> captureImage(REQUEST_CODE_IMAGE));
        ...
        if (AppCacheData.getOurInstance().getDashboardDetails() != null) {
            if (AppCacheData.getOurInstance().getDashboardDetails().getLocalBody() != null) {
                ...
                if (AppCacheData.getOurInstance().getUtilitySpinnerData() != null &&
                    ...
                    layers.add(AppCacheData.getOurInstance().getUtilitySpinnerData().getLayerDetails().getRoadJunction());
                }
            }
        }
        ...
        public boolean onTouch(View view, MotionEvent event) {
            switch (event.getAction()) {
                case MotionEvent.ACTION_MOVE:
                    getViewBinding().nsvRoadJunctionDetails.requestDisallowInterceptTouchEvent(true);
                    break;
                case MotionEvent.ACTION_UP:
                case MotionEvent.ACTION_CANCEL:
                    getViewBinding().nsvRoadJunctionDetails.requestDisallowInterceptTouchEvent(false);
                    break;
            }
    ...
    public void onImageCaptured(String path, int reqTypeCode) {
        if (AppCacheData.getOurInstance().getDashboardDetails() != null &&
            ...
            presenter.uploadImage(path, AppConstants.IMAGE_PATH_ROAD_JUNCTION, AppConstants.IMAGE_PATH_PHOTO1,
    ...
    public void onImageUploadSuccess(String imagePath, String imageType, String response) {
        ...
        Glide.with(this)
                ...
                .into(getViewBinding().imgRoadJunction);
    }
    ...
    public void onImageRemoved(int reqTypeCode) {
        photo = null;
        getViewBinding().imgRoadJunction.setImageResource(R.mipmap.ic_property_image_place_holder);
    }
