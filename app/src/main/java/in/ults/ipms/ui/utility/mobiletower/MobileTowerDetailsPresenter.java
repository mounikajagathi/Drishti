    ...
    void addUpdateContent(String buildingName, String place, String ownerName, String ownerAddress, String ownerMobile,
        ...
        if (AppCacheData.getOurInstance().isAssetUpdate()) {
            if (AppCacheData.getOurInstance().getBuildingAssetData() != null &&
                ...
                data.getMobileTowerDetails().setBuildingStatus(buildingStatus);
                data.getMobileTowerDetails().setBuildingUsage(buildingUsage);
                data.getMobileTowerDetails().setYearOfConstruction(yearOfConstruction);
                ...
                data.getMobileTowerDetails().setRoadWidth(roadWidth);
            ...
            details.setBuildingStatus(buildingStatus);
            details.setBuildingUsage(buildingUsage);
            details.setYearOfConstruction(yearOfConstruction);
            ...
            details.setRoadWidth(roadWidth);
