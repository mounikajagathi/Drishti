...
public interface IPlaygroundDetailsPresenter<V extends IPlaygroundDetailsView, I extends IPlaygroundDetailsInteractor> extends IBasePresenter<V, I> {
    void validateData(String location, String name, String type,String area,String surveyNo, String wardNo, String remarks, String photo, double locationLatitude, double locationLongitude);
}
