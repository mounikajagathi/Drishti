...
public interface IRoadDetailsPresenter<V extends IRoadDetailsView,I extends IRoadDetailsInteractor> extends IBasePresenter<V,I> {
    void saveRoadDetails(String roadName, String startPoint, String endPoint, String roadMaterial, String roadCategory, String maintainedBy, String length, String carriageWidth, String roadwayWidth, String footpathWidth, String rightWayWidth, String footpath,String footpathPlacement,String footpathConsMat,String environment,String boardResolution,String assetID,String wardNo, String remarks, String photo, GeomPolyLine geom);
}
