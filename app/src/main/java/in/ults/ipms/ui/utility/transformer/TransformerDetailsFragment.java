    ...
    public void setEditData() {
        if (AppCacheData.getOurInstance().getBuildingAssetData() != null) {
            ...
            if (transformerDetails != null) {
                ...
                getViewBinding().etSingleTube40W.setText(transformerDetails.getSingleTube());
                getViewBinding().etDoubleTube80W.setText(transformerDetails.getDoubleTube());
                getViewBinding().etLED35W.setText(transformerDetails.getLED());
                getViewBinding().etCFL36W.setText(transformerDetails.getCfl());
                getViewBinding().etBulb40W.setText(transformerDetails.getBulb());
                getViewBinding().etSodiumVapour180W.setText(transformerDetails.getSodiumVapour());
                getViewBinding().etConnectedLoadW.setText(transformerDetails.getConnectedLoad());
