    ...
    void addUpdateContent(String poleNumber, String location, String consumerNo, String applicationNo, String category, String singleTube, String doubleTube, String led, String cfl, String bulb, String sodiumVapour, String connectedLoad,
        ...
        if (AppCacheData.getOurInstance().isAssetUpdate()) {
            if (AppCacheData.getOurInstance().getBuildingAssetData() != null &&
                ...
                data.getTransformerDetails().setSingleTube(Integer.parseInt(singleTube));
                data.getTransformerDetails().setDoubleTube(Integer.parseInt(doubleTube));
                data.getTransformerDetails().setLED(Integer.parseInt(led));
                data.getTransformerDetails().setCfl(Integer.parseInt(cfl));
                data.getTransformerDetails().setBulb(Integer.parseInt(bulb));
                data.getTransformerDetails().setSodiumVapour(Integer.parseInt(sodiumVapour));
                data.getTransformerDetails().setWard(Long.parseLong(wardNo));
                data.getTransformerDetails().setConnectedLoad(Integer.parseInt(connectedLoad));
            ...
            details.setSingleTube(Integer.parseInt(singleTube));
            details.setDoubleTube(Integer.parseInt(doubleTube));
            details.setLED(Integer.parseInt(led));
            details.setCfl(Integer.parseInt(cfl));
            details.setBulb(Integer.parseInt(bulb));
            details.setSodiumVapour(Integer.parseInt(sodiumVapour));
            details.setWard(Long.parseLong(wardNo));
            details.setConnectedLoad(Integer.parseInt(connectedLoad));
