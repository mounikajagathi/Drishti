...
/**
 * Created by Mohammed Shafeeq on 25/03/18.
 */

public class AppProgressBar extends View {
    ...
    public AppProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        parseAttributes(context.obtainStyledAttributes(attrs, R.styleable.AppProgressBar));
        setAnimationEnabled();
    }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius =
                (int) a.getDimension(R.styleable.AppProgressBar_app_progress_bar_circleRadius, circleRadius);
        fillRadius = a.getBoolean(R.styleable.AppProgressBar_app_progress_bar_fillRadius, false);
        barWidth = (int) a.getDimension(R.styleable.AppProgressBar_app_progress_bar_barWidth, barWidth);
        rimWidth = (int) a.getDimension(R.styleable.AppProgressBar_app_progress_bar_rimWidth, rimWidth);
        float baseSpinSpeed =
                a.getFloat(R.styleable.AppProgressBar_app_progress_bar_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;
        barSpinCycleTime =
                a.getInt(R.styleable.AppProgressBar_app_progress_bar_barSpinCycleTime, (int) barSpinCycleTime);
        barColor = a.getColor(R.styleable.AppProgressBar_app_progress_bar_barColor, barColor);
        rimColor = a.getColor(R.styleable.AppProgressBar_app_progress_bar_rimColor, rimColor);
        linearProgress = a.getBoolean(R.styleable.AppProgressBar_app_progress_bar_linearProgress, false);
        if (a.getBoolean(R.styleable.AppProgressBar_app_progress_bar_progressIndeterminate, false)) {
            spin();
        }
        a.recycle();
    }
